...
class DesksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create desk" do
    assert_difference('Desk.count') do
      post desks_url, params: { desk: { current: @desk.current, ended_at: @desk.ended_at, started_at: @desk.started_at } }
    end
  ...
  test "should update desk" do
    patch desk_url(@desk), params: { desk: { current: @desk.current, ended_at: @desk.ended_at, started_at: @desk.started_at } }
